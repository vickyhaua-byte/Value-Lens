  ...
  return (
    ...
    >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="bg-white rounded-[40px] p-10 border border-slate-100 shadow-xl relative overflow-hidden bg-linear-to-br from-white to-slate-50/50 flex flex-col justify-center">
           ...
           <div className="relative z-10 space-y-6">
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <h4 className="text-lg font-black text-slate-800 uppercase tracking-widest">Summit Concierge</h4>
              </div>
              <p className="text-sm font-medium text-slate-500 leading-relaxed">
                Our AI engine synthesizes the entire TAB agenda into a single-page visual guide, specifically highlighting the most relevant booths and talks for you.
              </p>
              <div className="pt-4 flex items-center gap-2">
                 <Sparkles className="w-4 h-4 text-primary" />
                 <span className="text-[10px] font-black text-primary uppercase tracking-widest">Powered by TAB Intelligence</span>
              </div>
           </div>
        </section>
      </div>
