...
import LeadContentSynthesis from './components/LeadContentSynthesis';
import LeadAssetGeneration from './components/LeadAssetGeneration';
...
type LeadSubStage = 'dashboard' | 'synthesis' | 'fabrication';
...
export default function App() {
  ...
  const startFabricationWithContent = (content: string) => {
    setSharedContent(content);
    setLeadSubStage('fabrication');
  };
          ...
          {role === 'lead' && (
            <>
              {leadSubStage === 'dashboard' && (
                <LeadDashboard 
                  key="lead-dashboard"
                  onContentSynthesis={() => setLeadSubStage('synthesis')} 
                  onAssetGeneration={() => {
                    setSharedContent('');
                    setLeadSubStage('fabrication');
                  }}
              ...
              {leadSubStage === 'fabrication' && (
                <LeadAssetGeneration 
                  key="lead-fabrication"
